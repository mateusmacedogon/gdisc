...
export const DownloadModal: React.FC = () => {
  ...
  const windowsDownloadUrl = 'https://github.com/mateusmacedogon/gdisc/releases/latest/download/GDisC-1.0.4-x64.exe';
  const androidDownloadUrl = 'https://github.com/mateusmacedogon/gdisc/releases/latest/download/GDisC-1.0.4-debug.apk';
